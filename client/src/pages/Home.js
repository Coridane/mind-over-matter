    ...
    return (
        ...
        {/*What steps should you take as a parent?*/}
            ...
            <p className="steps-link">For more information on what steps parents should take, please visit  
                <a href="https://steadystridesaba.com/?gad_source=1&gclid=CjwKCAjw-eKpBhAbEiwAqFL0mvr5CdLPeMOg4Bmrd8SscQHtQvReHbevD-Lyt8T67x2AtvSPyXNInBoCAKMQAvD_BwE"> Steady Strides ABA</a>.</p>
            <hr />
        ...
        {/*Challenges for parents*/}
            ...
            <p className="challenge-link-1">For more information on common challenges of parenting an Autistic child, please visit <a href="https://caliberautism.com/blog/Common-Challenges-of-Parenting-an-Autistic-Child">Caliber Autism & Pediatric Therapy</a>.</p>
            <p className="challenge-link-2">If you are father that is in need of support, please visit <a href="https://podcasters.spotify.com/pod/show/realunfiltereddadjourneys?fbclid=IwAR0rYAcEEiAmpZQ73TV3XoVfhaBehRfuuwFluD-Whkh5ZdA842t80cQQJqQ">Real Unfiltered Dad Journeys</a>.</p>
            <hr />
        ...
        {/*Homebased Therapy - Main for game*/} 
            ...
            <ul className="game-list">
                <li><button onClick={()=>navigate("/gamePage")}>Memory Game</button></li> 
            </ul> 
            <hr />
